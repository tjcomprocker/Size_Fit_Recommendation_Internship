...
file1 = str(sys.argv[1])+"_sales/"+str(sys.argv[2])+"/results_1/tp"
file2 = str(sys.argv[1])+"_returns/"+str(sys.argv[2])+"/results_1/tp"
file3 = open(str(sys.argv[1])+"_nmi.txt",'a')
...
with open(file1,"r") as f:
	...
	for lines in content:
		cluster_output.append(map(int,(lines.split(split_str))[:-1]))
...
file3.write (str(purity_score(np.array(predicted),np.array(ground_truth)))+"\n")
file3.write (str(normalized_mutual_info_score(ground_truth,predicted))+"\n")
file3.write (str(adjusted_rand_score(ground_truth,predicted))+"\n")
